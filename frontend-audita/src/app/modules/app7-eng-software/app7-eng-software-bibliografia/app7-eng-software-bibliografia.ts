...
@Component({
  selector: 'app-app7-eng-software-bibliografia',
  standalone: true,
  imports: [CommonModule, RouterOutlet, CapaBibliografia],
  templateUrl: './app7-eng-software-bibliografia.html',
  styleUrl: './app7-eng-software-bibliografia.scss'
})
export class App7EngSoftwareBibliografia implements OnInit {

  /** 🔹 Bases centralizadas */
  private readonly ROUTE_BASE = '/home/app7-eng-software';
  private readonly ASSETS_BASE = 'assets/content/eng-software';
  ...
  public capas: CapaConfig[] = [
    {
      ...
      routePath: `${this.ROUTE_BASE}/bibliografia/manifesto-agil`,
