...
@Component({
  selector: 'app-app8-seg-info-bibliografia',
  imports: [CommonModule, RouterOutlet, CapaBibliografia],
  templateUrl: './app8-seg-info-bibliografia.html',
  styleUrl: './app8-seg-info-bibliografia.scss'
})
export class App8SegInfoBibliografia implements OnInit {

  /** 🔹 Bases centralizadas */
  private readonly ROUTE_BASE = '/home/app8-seg-info';
  private readonly ASSETS_BASE = 'assets/content/seg-info';
