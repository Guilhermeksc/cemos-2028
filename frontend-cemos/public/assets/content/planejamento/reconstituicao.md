...
## (2022) Condições que são consideradas que foi atingido o Estado Final Desejado
R: De modo geral, o EFD será atingido quando tiver sido alcançada uma ou mais das seguintes condições: 
    a) a estrutura de apoio ao esforço de guerra do oponente tiver sido afetada, impossibilitando-o de prosseguir com as operações;
    b) quebra da vontade de lutar do oponente;
    c) perda de condições do governo oponente em congregar o povo para o esforço de guerra; 
...
## (2022) Citar uma vantagem de ser FCj e uma vantagem de ser FCte Singular
R: A organização por Forças Componentes Singulares apresenta a característica de: 
(1) homogeneidade 
(2) relacionamento simples dentro de cada força 
(3) permite que cada comandante conheça profundamente os meios subordinados nos aspectos operacionais, logísticos e de adestramento. 
Por outro lado, a organização por Forças Conjunta Componentes proporciona:
(1) maior flexibilidade, advinda de uma maior gama de capacidades disponíveis
(2) permite distribuir os meios de forma balanceada, empregando-os nas três dimensões da guerra, na terra, no mar e no ar, sob um mesmo comando. 
...
## (2022) Dava uma situação dizendo que o D3 sugeriu elaborar um Diagrama de Relações para melhorar a visualização da abordagem operacional e orientar a LA. C ou E.
R: Errado. Desenho Operacional.

## (2022) Dava uma situação e perguntava qual era a característica das LA observada (ser implementada com as forças, apoio e tecnologia disponíveis, levando-se em consideração a oposição esperada e os custos financeiros permitidos).
R: Praticável
...
## (2022) Dava uma situação e perguntava qual era a característica das LA observada (cumpria a missão, mas feria duas limitações ao planejamento)
R: Inadequada
...
## (2021) CORRELACIONE  Fases do Exame da Situação Operacional.
...
## (2021) Num determinado planejamento, apresentava uma tabela com diversos fatores de força e fraqueza, e perguntava se dois deles eram corretos ou incorretos, justificando a resposta.
5.3.9.3 Ao relacionar os fatores, deve-se ter cuidado para não indicar como fator de força de um oponente o que já tenha sido apontado como fator de fraqueza do outro, e vice-versa. Pode-se relacionar, para ambos os lados, um mesmo fator de força ou de fraqueza, desde que representem aspectos que não se oponham entre si. Por exemplo, a existência de um conjunto balanceado de radares adequadamente distribuídos, para monitoramento do espaço aéreo, por parte de ambos os oponentes. Não deve ser relacionado, simplesmente, “o que não se tem” como um fator de fraqueza, pois isso poderia levar a uma listagem quase infinita de itens.

## (2021) Prova preliminar de APA – Apresentava duas condições observadas em uma LA e como ela deveria ser considerada em relação à prova de APA.
...
## (2021) Quem é o responsável por definir as regras e métodos para a condução do confronto, e qual será a função exercida por ele nesta fase?
5.4.4.3.5 A função de Coordenador do Confronto será exercida pelo ChEMCj ou por algum oficial indicado por ele. O papel do Coordenador é definir as regras e o método para a condução do Confronto, certificando-se que todos conheçam os aspectos que deverão ser examinados e fazer com que o trabalho progrida de acordo com o tempo disponível para a sua realização.

## (2021) Cite duas vantagens de disseminar o CPO de forma antecipada para as FCte por meio de uma Ordem Preparatória.
...
## (2022)  Correlacione com as tarefas das seções de EM
    (1) D-1 Organização
    (2) D-2 Inteligência
    (3) D-3 Operações
    (4) D-4 Logística
    (5) D-5 Planejamento
( 5 ) matrizes de sincronização
( 4 ) Evacuação aero médica
( 1 ) tratar assuntos de disciplina e justiça militar, dentro do EMCj
...
7.3.6.7.2 O propósito dessa reunião será fazer uma avaliação de danos dos alvos atacados, definir e priorizar os alvos que devem ser engajados no ambiente operacional ou em outros locais que afetem a Campanha, desde que autorizado pelo Comandante Supremo. Os participantes da reunião constituirão o Grupo de Coordenação de Apoio de Fogo, reunindo-se de acordo com a rotina de trabalho estabelecida, com antecedência adequada em relação à Reunião de Aprovação da Ordem de Coordenação. Cabe ressaltar que os alvos, dependendo do efeito desejado sobre os mesmos, poderão ser engajados tanto por meio de ações cinéticas e não cinéticas.
    (4) Reunião de aprovação da Ordem de Coordenação
...
## (2022) Correlacione com as características dos Comandos Operacionais e outros conceitos
    (1) ZD
    (2) ComDCiber
    (3) Defesa Aeroespacial
    (4) Defesa Territorial
    (5) Meios do ComZD
( 2 ) pertencente à estrutura regimental do Exército Brasileiro.
( 5 ) Não implica a subordinação automática das organizações ou meios sediados na área, somente os adjudicados.
( 3 ) Sua principal característica é que seus integrantes devem estar em condições de operar a qualquer momento.
( 1 ) proporciona maior nível de segurança.
( 4 ) tem a finalidade de preservar o potencial material e humano da Nação.
