...
|---|---|---|---|---|---|---|---|
| 2 | Pág 49| 10 | O Estado nacional atual é uma corporação territorial de um povo, constituída como nação, que se realiza por um ordenamento jurídico complexo. | O Estado nacional atual se baseia primariamente no parentesco e se realiza sem um ordenamento jurídico complexo, focando apenas na pessoa do governante. | O Estado nacional é uma corporação territorial de um povo constituído como nação, que se estabelece através de um ordenamento jurídico. | | |
