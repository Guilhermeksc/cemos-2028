...
Instruções específicas:
    ...
    bibliografia_id" será preenchido com: 3.
...
“assunto” será preenchido com: 213.

Exemplo de saída esperada:

					
| bibliografia_id | pergunta | resposta | prova | páginas | assunto |
| 3 | Pergunta contextualizada | Resposta objetiva, conforme o item X.X do texto. |  | Pág. 11 | 213 |
