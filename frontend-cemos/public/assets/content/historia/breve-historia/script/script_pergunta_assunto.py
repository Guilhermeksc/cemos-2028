...
BASE_DIR = Path(
    "/home/guilherme/Projetos/cemos-2028/cemos-2028/frontend-cemos/public/assets/content/historia/breve-historia"
)
...
def gerar_vf(paginas: dict):
    ...
    salvar_markdown(ARQUIVOS_SAIDA["vf"], header, [])
...
def gerar_flashcards(paginas: dict):
    ...
    salvar_markdown(ARQUIVOS_SAIDA["flashcards"], header, [])
...
def gerar_multipla_escolha(paginas: dict):
    ...
    salvar_markdown(ARQUIVOS_SAIDA["multipla"], header, [])
...
def gerar_correlacao(paginas: dict):
    ...
    salvar_markdown(ARQUIVOS_SAIDA["correlacao"], header, [])
