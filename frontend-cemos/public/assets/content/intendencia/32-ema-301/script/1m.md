Sua tarefa é ler o conteúdo do arquivo cap1.md e criar um banco de questões no arquivo m1.md com 1 questão por página de múltipla escolha.
...
| 67| Pág 15 | 209 | Qual teórico é considerado o fundador (...)? | Immanuel | Hans | Alexander | Nye | b | conforme o **item 4.3.1**, Morgenthau é (...). |
