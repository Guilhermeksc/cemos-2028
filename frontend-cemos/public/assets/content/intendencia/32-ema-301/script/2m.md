Sua tarefa é ler o conteúdo do arquivo cap2.md e criar um banco de questões no arquivo m2.md com 1 questão por página de múltipla escolha.
...
| 67| Pág 15 | 241 | Qual teórico é considerado o fundador (...)? | Immanuel | Hans | Alexander | Nye | b | conforme o **item 4.3.1**, Morgenthau é (...). |
