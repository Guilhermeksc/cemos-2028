Sua tarefa é ler integralmente o conteúdo do arquivo cap1.md e criar um banco de questões de correlação entre colunas no arquivo c1.md, no formato de associação lógica, conforme as instruções abaixo.
...
| bibliografia_id | paginas | assunto | pergunta | coluna_a | coluna_b | resposta_correta | justificativa_resposta_certa | caiu_em_prova | ano_prova |
| 67| Pág. 11 | 209 | Relacione os conceitos geopolíticos com seus autores correspondentes. | ["Heartland", "Eurasianismo", "Destino Manifesto Russo"] | ["Mackinder", "Dugin", "March"] | {"0": "0", "1": "1", "2": "2"} | Cada conceito está corretamente associado ao pensador que o desenvolveu ou aplicou à Rússia. |  |  |
