Sua tarefa é ler o conteúdo do arquivo cap4.md e criar um banco de questões.
...
| 68| Pág 15 | 239 | Qual teórico é considerado o fundador (...)? | Immanuel | Hans | Alexander | Nye | b | conforme o **item 4.3.1**, Morgenthau é (...). |
