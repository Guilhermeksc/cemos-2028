...
parametros_base = {
    "3":   {"numero": 210, "assunto": "Capítulo 3 - A Guerra Naval"},
    "4":   {"numero": 239, "assunto": "Capítulo 4 - O Poder Naval nas atividades de emprego limitado da força"},
    "5":   {"numero": 240, "assunto": "Capítulo 5 - O Poder Naval nas atividades benignas"},                
}
...
justificativa_resposta_certa: explicação objetiva. ex: “Conforme o item 1.2 …”
