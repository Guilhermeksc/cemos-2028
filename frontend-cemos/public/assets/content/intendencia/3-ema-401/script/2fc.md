...
Instruções específicas:
    ...
    bibliografia_id" será preenchido com '38'.
    ...
    "assunto" deve ser 'Cap. 2 - O Sistema de Mobilização Marítima - SIMOMAR'.
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 38 | Pergunta contextualizada | Resposta objetiva, conforme o item X.X do texto. |  | Pág. 11 | Cap. 1 - Disposições Gerais |
