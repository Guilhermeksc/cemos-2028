...
Instruções específicas:
    ...
    bibliografia_id" será preenchido com '39'.
    ...
    “assunto” será preenchido com 'Doutrina de Mobilização Militar'.
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 38 | Pergunta contextualizada | Resposta objetiva, conforme o item X.X do texto. |  | Pág. 11 | Doutrina de Mobilização Militar |
