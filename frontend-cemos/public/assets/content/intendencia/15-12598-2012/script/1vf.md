...
3. Regras de preenchimento das colunas
    bibliografia_titulo" será 'Lei nº 12.598 - Produtos e Sistemas de Defesa'.
    “paginas” será preenchido com o marcador ## referente a página ao qual se refere, ex: se ## Página 11 então 'Pág 11'
    “assunto” será preenchido com 'Lei - Produtos e Sistemas de Defesa'.
...
| bibliografia_titulo | paginas | assunto | afirmacao_verdadeira | afirmacao_falsa | justificativa_resposta_certa | caiu_em_prova | ano_prova |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| EMA-135 | Pág. 11 | Cap. 5 - Mobilização| A Mobilização Nacional é  (...). | A Mobilização Nacional é composta por (...). | De acordo com **art. 2º, I**, a Mobilização Nacional (...). | |  |