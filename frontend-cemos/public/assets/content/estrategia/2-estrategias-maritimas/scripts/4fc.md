...
Instruções específicas:
    ...
    bibliografia_id" será preenchido com: 4.
...
“assunto” será preenchido com: 154.

Exemplo de saída esperada:

					
| bibliografia_id | pergunta | resposta | prova | páginas | assunto |
| 4 | Pergunta contextualizada | Resposta objetiva, conforme o item X.X do texto. |  | Pág. 11 | 154 |
