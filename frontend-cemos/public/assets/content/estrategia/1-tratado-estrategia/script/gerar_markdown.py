...
parametros_base = {
    "1":   {"numero": 1, "assunto": 139},
    "2":  {"numero": 2, "assunto": 140},
    "3": {"numero": 3, "assunto": 141},
    "4": {"numero": 4, "assunto": 142},
    "5":  {"numero": 5, "assunto": 143},
    "8": {"numero": 8, "assunto": 144},     
    "9": {"numero": 9, "assunto": 145},
    "10": {"numero": 10, "assunto": 146},   
    "11": {"numero": 11, "assunto": 147},
    "12": {"numero": 12, "assunto": 148},
    "14": {"numero": 14, "assunto": 149},
    "15": {"numero": 15, "assunto": 150},
    "16": {"numero": 16, "assunto": 151},
    "17": {"numero": 17, "assunto": 152},              
}
...
| bibliografia_id | paginas | assunto | pergunta | coluna_a | coluna_b | resposta_correta | justificativa_resposta_certa | caiu_em_prova | ano_prova |
| {id_base}| Pág. 11 | {assunto} | Relacione os conceitos geopolíticos com seus autores correspondentes. | ["Heartland", "Eurasianismo", "Destino Manifesto Russo"] | ["Mackinder", "Dugin", "March"] | {{"0": "0", "1": "1", "2": "2"}} | Cada conceito está corretamente associado ao pensador que o desenvolveu ou aplicou à Rússia. |  |  |
"""
...
| {id_base}| Pág 15 | {assunto} | Qual teórico é considerado o fundador (...)? | Immanuel | Hans | Alexander | Nye | b | conforme o **item 4.3.1**, Morgenthau é (...). |
...
| bibliografia_id | paginas | assunto | afirmacao_verdadeira | afirmacao_falsa | justificativa_resposta_certa | caiu_em_prova | ano_prova |
| {id_base} | Pág. 11 | {assunto}| A Mobilização Nacional é  (...). | A Mobilização Nacional é (...), sem relação com agressão externa. | De acordo com **art. 2º, I**, a Mobilização Nacional (...). | |  |
"""
...
for parte, dados in parametros_base.items():
    ...
    for s in sufixos:
        ...
        (BASE_DIR / f"{s}{numero}.md").write_text("", encoding="utf-8")
