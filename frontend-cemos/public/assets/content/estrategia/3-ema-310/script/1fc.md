...
Instruções específicas:
    ...
    bibliografia_id" será preenchido com: 35.
...
“assunto” será preenchido com: 157.

Exemplo de saída esperada:

					
| bibliografia_id | pergunta | resposta | prova | páginas | assunto |
| 35 | Pergunta contextualizada | Resposta objetiva, conforme o item X.X do texto. |  | Pág. 11 | 157 |
