Sua tarefa é ler a lista de perguntas e respostas e verificar os arquivos cap.md  para criar um banco de questões v ou f, do seguinte modo:
    ...
    Criar  3 assertivas por páginas uma versão verdadeira e uma falsa coerente (invertendo o sentido ou alterando um conceito-chave).
...
Instruções específicas:
    ...
    bibliografia_id" será preenchido com 'Decreto nº 154/1991 - Entorpecentes e  Psicotrópicos.'.

    “paginas” será preenchido com o markador ## referente a página ao qual se refere, ex: se ## Página 11 então 'Pág 11 ...'

    “assunto” será preenchido com 'Entorpecentes e  Psicotrópicos.'.
