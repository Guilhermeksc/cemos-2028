...
parametros_base = {
    ...
    "parte2":  {"numero": 2, "assunto": "Parte II - Mar Territorial e Zona Contígua"},
    "parte3": {"numero": 3, "assunto": "Parte III - Estreitos Utilizados para a Navegação Internacional"},
    "parte4":  {"numero": 4, "assunto": "Parte IV - Estados Arquipélagos"},
    "parte5":   {"numero": 5, "assunto": "Parte V - Zona Econômica Exclusiva"},
    "parte6":  {"numero": 6, "assunto": "Parte VI - Plataforma Continental"},
    "parte7":  {"numero": 7, "assunto": "Parte VII - Alto Mar"},
    "parte8":  {"numero": 8, "assunto": "Parte VIII, IX e X - Ilhas, mares fechados e acesso ao mar"},
    "parte11":  {"numero": 11, "assunto": "Parte XI - A Área"},
    "parte12":  {"numero": 12, "assunto": "Parte XII - Proteção e Preservação do Meio Ambiente"},
    "parte13":  {"numero": 13, "assunto": "Parte XIII - Investigação Científica Marinha"},
    "parte14":  {"numero": 14, "assunto": "Parte XVI - Desenvolvimento e Transferência de Tecnologia Marinha"},
    "parte15":  {"numero": 15, "assunto": "Parte XV - Solução de Controvérsias"},        
}
