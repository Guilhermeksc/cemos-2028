...
@Component({
  selector: 'app-portaria586',
  imports: [
    CommonModule,
    HttpClientModule,
    LivroIndividual
  ],
  templateUrl: './portaria586.html',
  styleUrl: './portaria586.scss',
  encapsulation: ViewEncapsulation.None
})
export class Portaria586 implements OnInit {
  // Configuração do LivroIndividual
  contentPath: string = 'assets/content/intendencia/20-586-2006';
  fileNames: string[] = [
    'cap1.md',
  ];
