...
@Component({
  selector: 'app-md-41-m-01',
  imports: [
    CommonModule,
    HttpClientModule,
    LivroIndividual
  ],
  templateUrl: './md-41-m-01.html',
  styleUrl: './md-41-m-01.scss',
  encapsulation: ViewEncapsulation.None
})
export class Md41M01 implements OnInit {
// Configuração do LivroIndividual
contentPath: string = 'assets/content/intendencia/4-md-41-m-01';
fileNames: string[] = [
  'cap1.md',
];
