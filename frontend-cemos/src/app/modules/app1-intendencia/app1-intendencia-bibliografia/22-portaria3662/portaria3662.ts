...
@Component({
  selector: 'app-portaria3662',
  imports: [
    CommonModule,
    HttpClientModule,
    LivroIndividual
  ],
  templateUrl: './portaria3662.html',
  styleUrl: './portaria3662.scss',
  encapsulation: ViewEncapsulation.None
})
export class Portaria3662 implements OnInit {
  // Configuração do LivroIndividual
  contentPath: string = 'assets/content/intendencia/22-3662-2021';
  fileNames: string[] = [
    'cap1.md',
  ];
