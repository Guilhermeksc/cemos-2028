...
@Component({
  selector: 'app-portaria899',
  imports: [
    CommonModule,
    HttpClientModule,
    LivroIndividual
  ],
  templateUrl: './portaria899.html',
  styleUrl: './portaria899.scss',
  encapsulation: ViewEncapsulation.None
})
export class Portaria899 implements OnInit {
  // Configuração do LivroIndividual
  contentPath: string = 'assets/content/intendencia/19-899-2005';
  fileNames: string[] = [
    'cap1.md',
  ];
