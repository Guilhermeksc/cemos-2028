...
@Component({
  selector: 'app-decreto6592',
  imports: [
    CommonModule,
    HttpClientModule,
    LivroIndividual
  ],
  templateUrl: './decreto6592.html',
  styleUrl: './decreto6592.scss',
  encapsulation: ViewEncapsulation.None
})
export class Decreto6592 implements OnInit {
  // Configuração do LivroIndividual
  contentPath: string = 'assets/content/intendencia/8-decreto6592';
  fileNames: string[] = [
    'cap1.md',
  ];
