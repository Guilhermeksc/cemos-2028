...
@Component({
  selector: 'app-lei12598',
  imports: [
    CommonModule,
    HttpClientModule,
    LivroIndividual
  ],
  templateUrl: './lei12598.html',
  styleUrl: './lei12598.scss',
  encapsulation: ViewEncapsulation.None
})
export class Lei12598 implements OnInit {
  // Configuração do LivroIndividual
  contentPath: string = 'assets/content/intendencia/15-12598-2012';
  fileNames: string[] = [
    'cap1.md',
  ];
