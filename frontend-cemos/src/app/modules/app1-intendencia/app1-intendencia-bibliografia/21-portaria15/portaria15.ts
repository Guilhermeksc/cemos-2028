...
@Component({
  selector: 'app-portaria15',
  imports: [
    CommonModule,
    HttpClientModule,
    LivroIndividual
  ],
  templateUrl: './portaria15.html',
  styleUrl: './portaria15.scss',
  encapsulation: ViewEncapsulation.None
})
export class Portaria15 implements OnInit {
  // Configuração do LivroIndividual
  contentPath: string = 'assets/content/intendencia/21-15-2018';
  fileNames: string[] = [
    'cap1.md',
  ];
