Sua tarefa é ler a lista de perguntas e respostas e verificar os arquivos cap.md  para criar um banco de questões v ou f, do seguinte modo:
    ...
    Criar 40 novas questões  uma versão verdadeira e uma falsa coerente (invertendo o sentido ou alterando um conceito-chave).
...
Instruções específicas:
    ...
    “assunto” será preenchido com 'Cap. 1 - Divisões Legais dos oceanos e do espaço aéreo'
