...
Write-Host "⚠️  Este build usará cemos2028.site como API URL" -ForegroundColor Yellow

# Navega para o diretório do frontend
Set-Location -Path ".\frontend"

# Executa o build em modo produção (usa cemos2028.site)
npm run build:prod
...
if ($LASTEXITCODE -eq 0) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "   Certifique-se de que o domínio cemos2028.site está configurado" -ForegroundColor White
    } else {
